  ...
  try {
    ...
    for (const rubrica of rubricas) {
      ...
      try {
        ...
        console.log(`Rubrica ${rubrica.rubrica} já existe ou erro:`, e.message);
      }
    }
    ...
    for (const mapeamento of mapeamentos) {
      try {
        ...
        console.log(`Mapeamento ${mapeamento.termo_origem} já existe ou erro:`, e.message);
      }
    }
    ...
    return Response.json({
      ...
      total_inicial_utilizado: 67900,
      saldo_restante: 549500,
    });
  } catch (error) {
    return Response.json(
