...
// Mantemos APP_BASE_URL constante apenas como compat para código que ainda a referencia;
// o link real é derivado da requisição em runtime via buildAppLink(req).
const APP_BASE_URL = '';
