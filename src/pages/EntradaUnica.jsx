...
import ZerarFilaIAButton from '@/components/entrada/ZerarFilaIAButton';
  ...
  async function enviarIntakeParaAprovacao(intake) {
    try {
      ...
      const novaPurchase = await base44.entities.PurchaseRequest.create({
        ...
        meta_id: ia.meta_id || ia.meta_sugerida || intake.meta_id || '',
        ...
        natureza_despesa: rubrica?.natureza_despesa || rubrica?.natureza_codigo || '',
        natureza_codigo: rubrica?.natureza_codigo || rubrica?.natureza_despesa || '',
        nome_natureza: rubrica?.nome_natureza || rubrica?.natureza_nome || '',
        centro_custo,
        ...
        data_emissao: ia.nf_data_emissao || ia.data_emissao || intake.nf_data_emissao || '',
