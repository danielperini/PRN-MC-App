...
Retorne apenas o JSON válido, sem explicações adicionais.`;
        ...
        base44.integrations.Core.InvokeLLM({
          ...
          response_json_schema: {
            ...
            properties: {
              ...
              nf_destinatario_nome: { type: 'string' }, descricao_servico: { type: 'string' },
              municipio: { type: 'string' }, estado: { type: 'string' },
      ...
      const tipoDetectado = resultado?.tipo_documento === 'NOTA_FISCAL_XML' ? 'NOTA_FISCAL_XML' : resultado?.tipo_documento === 'NOTA_FISCAL_PDF' ? 'NOTA_FISCAL_PDF' : tipoFallback;
