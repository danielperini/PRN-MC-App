...
{ id: '2026-08-portal-agenda-museus', title: 'Programação Agosto 2026 nos Museus do Centro de BH', sourceName: 'Portal Belo Horizonte', sourceType: 'Canal institucional', publishedDate: '2026-08-01', relevance: 'Alta', platform: 'Site', relatedTo: ['Museus Centro', 'Programação', 'MHAB', 'MIS BH', 'MUMO', 'Viaduto das Artes'], url: 'https://portalbelohorizonte.com.br/2026/eventos/apresentacao-artistica/patrimonio-memoria-e-identidades-culturais-memoria-social-e-urbana/agenda-rede-de-identidades-culturais-junho-de', summary: 'Agenda oficial da programação de agosto de 2026 nos museus do centro de Belo Horizonte, com atividades integradas do projeto.' },
{ id: '2026-07-portal-brincadeiras', title: 'Oficina: Resgatando Brincadeiras no Museus Centro', sourceName: 'Portal Belo Horizonte', sourceType: 'Agenda cultural', publishedDate: '2026-07-18', relevance: 'Média/Alta', platform: 'Site', relatedTo: ['Museus Centro', 'Oficinas', 'Programação', 'Viaduto das Artes'], url: 'https://portalbelohorizonte.com.br/museuscentro/2026/eventos/oficina/cultural/oficina-resgatando-brincadeiras', summary: 'Oficina cultural do projeto Museus Centro realizada em julho de 2026, resgatando brincadeiras tradicionais com acesso gratuito.' },
{ id: '2026-07-culturadoria-ferias', title: 'Férias nos museus do Centro de BH com arte, moda e diversão gratuita', sourceName: 'Culturadoria', sourceType: 'Mídia cultural', publishedDate: '2026-07-10', relevance: 'Alta', platform: 'Site', relatedTo: ['Museus Centro', 'MHAB', 'MIS BH', 'MUMO', 'Viaduto das Artes', 'Oficinas'], url: 'https://culturadoria.com.br/ferias-nos-museus-do-centro-de-bh/', summary: 'Agenda cultural destaca as atividades de férias nos museus do centro de BH, com oficinas, filmes e arte gratuita em parceria com o Viaduto das Artes.' },
{ id: '2026-07-jornalbras-vac', title: 'Verão Arte Contemporânea (VAC) ocupa BH com foco em múltiplas linguagens artísticas', sourceName: 'Jornal do Bras', sourceType: 'Mídia cultural', publishedDate: '2026-07-05', relevance: 'Média/Alta', platform: 'Site', relatedTo: ['Viaduto das Artes', 'Arte', 'Cultura', 'Museus Centro', 'Exposições'], url: 'https://jornaldobras.com.br/noticia/105326/verao-arte-contemporanea-vac-ocupa-bh-com-foco-em-multiplas-linguagens-artisticas', summary: 'Cobertura do Verão Arte Contemporânea (VAC) 2026 em BH, com menção ao Viaduto das Artes e exposições integradas ao projeto.' },
{ id: '2026-07-viaduto-marcus', title: 'Marcus Deusdedit no Museus Centro — registro fotográfico do Viaduto das Artes', sourceName: 'Viaduto das Artes (Instagram)', sourceType: 'Rede social', publishedDate: '2026-07-26', relevance: 'Média', platform: 'Instagram', relatedTo: ['Viaduto das Artes', 'Museus Centro', 'Daniel Moreira', '#MuseusCentro'], url: 'https://www.instagram.com/reel/CktCkqGPmFS/', summary: 'Registro fotográfico de Marcus Deusdedit no projeto Museus Centro, com crédito de Daniel Moreira/Viaduto das Artes.' },
{ id: '2026-06-festa-da-luz', title: '5ª edição da Festa da Luz transforma o hipercentro de BH em galeria a céu aberto', sourceName: 'Festa da Luz (Instagram)', sourceType: 'Mídia cultural', publishedDate: '2026-06-25', relevance: 'Média', platform: 'Instagram', relatedTo: ['Belo Horizonte', 'Arte', 'Cultura', 'Museus Centro'], url: 'https://www.instagram.com/reel/DaCHDOsuN1f/?hl=en', summary: 'A 5ª edição da Festa da Luz 2026 transformou o hipercentro de Belo Horizonte em galeria de arte a céu aberto entre 25 e 28 de junho.' },
{ id: '2026-03-mis-outono', title: 'Outono no MIS BH com programação quentinha aos sábados', sourceName: 'MIS BH (Instagram)', sourceType: 'Rede social', publishedDate: '2026-03-27', relevance: 'Média', platform: 'Instagram', relatedTo: ['MIS BH', 'Museus Centro', 'Viaduto das Artes', 'Daniel Moreira', '#MuseusBH'], url: 'https://www.instagram.com/reel/DWoioBdDnmS/', summary: 'Programação de outono no MIS BH aos sábados, com foto de Daniel Moreira/Viaduto das Artes e menção ao Museus Centro.' },
{ id: '2026-mis-dublagem', title: 'Oficina de Dublagem no MIS BH fortalece ações formativas do Museus Centro', sourceName: 'MIS BH (Facebook)', sourceType: 'Rede social', publishedDate: '2026-05-20', relevance: 'Média', platform: 'Facebook', relatedTo: ['MIS BH', 'Museus Centro', 'Oficinas', 'Viaduto das Artes'], url: 'https://www.facebook.com/museudaimagemedosombh/videos/2095969857983743/', summary: 'Oficina de Dublagem no MIS BH reuniu participantes em encontro de aprendizado e experimentação, fortalecendo as ações formativas do projeto Museus Centro.' }];
