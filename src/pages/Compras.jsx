        ...
        <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">3º Termo Aditivo — R$ 1.320.000</p>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              ...
              <Select value={filters.meta_id} onValueChange={v => setFilters(f => ({ ...f, meta_id: v }))}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="MC3A-21">MC3A-21 — Exposição MUMO</SelectItem>
                  <SelectItem value="MC3A-22">MC3A-22 — Consultorias</SelectItem>
                  <SelectItem value="MC3A-EXTRA">MC3A-EXTRA — Meta Extra</SelectItem>
                </SelectContent>
              </Select>
            </div>
