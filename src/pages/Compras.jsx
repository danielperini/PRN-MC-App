...
import { useQuery, useQueryCli// 🔥 VERSÃO LIMPA E ESTÁVEL — SEM DUPLICAÇÃO E SEM REGRESSÃO
...
// ... (continua exatamente igual até o trecho das tabs)
        ...
        <div className="-mx-4 mb-6 flex w-fit gap-1 overflow-x-auto rounded-none bg-gray-100 p-1 px-4 md:-mx-6 md:px-6">
          {[
            ...
            // 🔒 AJUSTE AQUI (única alteração real)
