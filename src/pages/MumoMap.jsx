...
function MumoMapInner() {
  ...
  const { data: opportunities = [], refetch: refetchOps } = useQuery({
    queryKey: ['territorial-opportunities', 'MUMO'],
    queryFn: () =>
  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-600 mt-1">
                Moda, design e criatividade — fomentando economia criativa
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        <MobilizationSummaryCard museu_sigla="MUMO" title="Museu de Moda" />
      </div>
    </div>
  );
}
...
export default function MumoMap() {
  return <RequireAuth><MumoMapInner /></RequireAuth>;
}