...
Analise o documento e extraia os campos abaixo em JSON.

REGRA CRÍTICA DE DUPLICIDADE:
Para avaliar duplicidade de nota fiscal, NUNCA use apenas o número da NF.
A chave correta de duplicidade deve considerar obrigatoriamente:
1. nf_numero
2. nf_emitente_cpf_cnpj
3. nf_valor_total

A nota só deve ser considerada duplicada quando NF + CNPJ/CPF do emitente + valor total forem iguais.
Se o número da NF for igual, mas o CNPJ/CPF do emitente ou o valor forem diferentes, NÃO classifique automaticamente como duplicidade.

Extraia o máximo possível com precisão, especialmente:
- número da NF
...

{
  ...
  "banco": "nome do banco do emitente se informado",
  ...
  "rubrica_nome_sugerida": "nome mais provável da rubrica orçamentária",
  "chave_duplicidade": "nf_numero + nf_emitente_cpf_cnpj + nf_valor_total",
  "avaliacao_duplicidade": "usar apenas como referência; duplicidade real exige mesma NF, mesmo CNPJ/CPF e mesmo valor",
        ...
        base44.integrations.Core.InvokeLLM({
          ...
          response_json_schema: {
            ...
            properties: {
              ...
              chave_duplicidade: { type: 'string' },
              avaliacao_duplicidade: { type: 'string' },
