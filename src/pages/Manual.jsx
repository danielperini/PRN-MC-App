...
const SECOES = [
  ...
  },
  {
    ...
    description: 'Fluxo unificado de upload de NFs (PDF+XML), fotos e contratos com análise automática por IA e revisão obrigatória do autor.',
    content: [
      'Acesse "Entrada de Documentos" no menu lateral para enviar qualquer documento ao sistema: notas fiscais, fotos de atividades, contratos, recibos e documentos administrativos.',
      'Arraste ou selecione os arquivos na área de upload — o sistema aceita PDF, XML, imagens (JPG, PNG) e documentos administrativos.',
      'Para NOTAS FISCAIS: envie o arquivo PDF e o arquivo XML ao mesmo tempo, no mesmo lote. O sistema reconhece o par e os vincula automaticamente pelo número da nota fiscal. Enviar os dois juntos garante extração completa dos dados (emitente, valor, data, chave de acesso).',
      'Após enviar os arquivos, você verá o status "ANALISANDO IA". Aguarde alguns minutinhos (entre 1 e 3 minutos) enquanto a IA lê o documento e extrai os campos automaticamente. Não é necessário ficar na tela; você pode voltar depois.',
      'Quando a análise termina, o documento muda para o status "AGUARDANDO REVISÃO". Ele aparece na sua fila de documentos pronto para ser conferido.',
      'É o próprio autor — quem subiu o documento — quem revisa os dados extraídos pela IA: fornecedor/emitente, valor total, data de emissão, número da NF e chave de acesso. Verifique cada campo, corrija o que estiver errado e complete o que faltar.',
      'Somente após a revisão (e com os dados corretos) você clica em "ENVIAR PARA APROVAÇÃO". O documento segue para a coordenação, que valida e aprova. Sem essa revisão, o documento fica parado na fila.',
      'Para FOTOS de atividade: informe a atividade correspondente e ajuste a legenda sugerida pela IA antes de salvar.',
      'Para CONTRATOS: a IA extrai dados (valor, parcelas, vigência) e vincula ao membro da equipe correto — revise antes de confirmar.',
      'Resumo do fluxo: ENVIAR ARQUIVOS (PDF+XML juntos) → ANALISANDO IA (aguarde) → AGUARDANDO REVISÃO (você confere os dados) → ENVIAR PARA APROVAÇÃO (coordenação aprova).',
      'Coordenadores têm acesso a um painel de revisão para validar e aprovar documentos em lote após a revisão do autor.',
    ],
  },
  {
    id: 'nf-equipe',
  ...
  },
  {
    ...
    description: 'Chat conectado à base de conhecimento para tirar dúvidas operacionais e consultar dados do projeto.',
    content: [
      'Clique no ícone de balão no canto inferior direito da tela (em qualquer página) para abrir o chat do Assistente de IA.',
      'O assistente está conectado à base de conhecimento da plataforma: Biblioteca de Conhecimento, Programação (agenda), Compras, Rubricas, Equipe, Pagamentos e endereços dos museus.',
      'Ele responde perguntas sobre: como submeter uma compra, como aprovar uma NF, como enviar um relatório, status de compras aprovadas/pagas, quem é quem na equipe, endereços e contatos dos museus, programação cultural por museu e mês, saldos de rubricas e muito mais.',
      'Para fazer uma boa pergunta: seja objetivo e específico. Exemplos: "Como submeto uma nota fiscal?", "Qual o saldo da rubricula de comunicação do MIS?", "Quando é a próxima atividade do MUMO?", "Quem são os educadores do MHAB?".',
      'O assistente responde em segundos, com passo a passo quando a pergunta é operacional (caminho na tela → botão principal → passos numerados → pontos de atenção).',
      'Ele NÃO acessa dados financeiros individuais sigilosos (ex: valor exato pago a uma pessoa específica) — apenas informações operacionais e de base de conhecimento.',
      'Para melhorar a qualidade das respostas, adicione documentos à Biblioteca de Conhecimento (manuais, regras operacionais, contratos, planilhas). Quanto mais contexto, melhores as respostas.',
      'Há também a aba "Busca" dentro do chat, que permite pesquisar compras aprovadas e pagas por museu, fornecedor ou período de forma direta.',
      'Se a resposta não for suficiente, revise a Biblioteca de Conhecimento, reformule a pergunta com mais detalhes ou consulte este Manual.',
    ],
  },
  {
    id: 'comunicacao',
...
const FAQ_GRUPOS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Preciso enviar o PDF e o XML da NF juntos?', a: 'Sim, sempre que possível envie os dois no mesmo lote. O sistema os vincula automaticamente pelo número da nota e extrai os dados completos (emitente, valor, data, chave de acesso). Se faltar um, o documento pode ser enviado, mas a análise fica incompleta e pode ser devolvido.' },
      { q: 'Quanto tempo espero depois de enviar os arquivos?', a: 'Alguns minutinhos. Após o upload o status fica "ANALISANDO IA" enquanto a IA lê o documento e extrai os campos. Você não precisa ficar na tela — pode voltar depois e o documento aparecerá com status "AGUARDANDO REVISÃO".' },
      { q: 'Quem revisa os dados extraídos pela IA?', a: 'Você mesmo, que fez o upload. Quando o status muda para "AGUARDANDO REVISÃO", abra o documento, confira os campos (fornecedor, valor, data, número), corrija o que estiver errado e só então clique em "ENVIAR PARA APROVAÇÃO". Sem essa revisão o documento fica parado na fila.' },
    ],
  },
  {
    ...
    faqs: [
      ...
      { q: 'Como abro o chat do Assistente de IA?', a: 'Clique no ícone de balão preto no canto inferior direito de qualquer tela. O chat abre com as abas "Chat" (perguntas) e "Busca" (pesquisa de compras aprovadas/pagas).' },
      { q: 'O que o Assistente de IA consegue responder?', a: 'Passo a passo de fluxos (submeter compra, aprovar NF, enviar relatório), status de compras, saldo de rubricas, quem é quem na equipe (função/regime), endereços e contatos dos museus e programação cultural por museu e mês. Ele usa a Biblioteca de Conhecimento e os dados do projeto.' },
      { q: 'Quanto tempo o Assistente demora para responder?', a: 'Normalmente poucos segundos. Se a pergunta for muito genérica, tente ser mais específico (cite museu, mês, rubrica ou fluxo) para obter resposta mais útil.' },
    ],
  },
];
