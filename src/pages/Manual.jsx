...
const SECOES = [
  ...
  },
  {
    ...
    description: 'Personalize as cores do sistema entre o tema padrão e o tema Museu BH.',
    content: [
      'Acesse "Aparência e Manutenção" no menu lateral.',
      'No topo da página, selecione o tema desejado: "Tema Atual" (padrão escuro) ou "Tema Museu BH" (azul institucional).',
      'A alteração é aplicada imediatamente em toda a interface.',
      'Administradores podem voltar ao tema padrão a qualquer momento clicando em "Tema Atual".',
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Como identificar e remover duplicatas com segurança.',
    content: [
      'Acesse "Aparência e Manutenção" no menu lateral.',
      'Role até a seção "Ferramenta Administrativa — Relatórios Duplicados".',
      'Clique em "Verificar Duplicados" — o sistema lista as duplicatas encontradas por autor e período.',
      'Revise a lista antes de confirmar a exclusão.',
      'O sistema faz backup automático no AuditLog antes de remover qualquer item.',
      'Apenas duplicatas reais são removidas — o original é sempre preservado.',
      'Nunca são apagados arquivos únicos ou vinculados a registros originais.',
      'Ao final, é exibido um resumo com o que foi removido e o que foi preservado.',
    ],
  },
  {
    id: 'backup',
    ...
    description: 'Como verificar e restaurar backups do sistema.',
    content: [
      'O sistema realiza backup automático de arquivos críticos no Google Drive.',
      'Acesse o módulo de Arquivos ou o painel administrativo para verificar o status do backup.',
      'Backups são organizados por tipo de arquivo na pasta principal do Drive: Compras, Notas Fiscais, Relatórios, Documentos, Contratos, Logs.',
      'O backup diário verifica quais arquivos já existem antes de enviar — evita duplicidade.',
      'Antes de ações críticas (exclusão, aprovação final), o sistema realiza backup preventivo.',
      'Para restaurar um arquivo, acesse o Google Drive e localize a pasta correspondente ao tipo de documento.',
      'Cada operação de backup é registrada em log com data, hora, usuário e resultado.',
    ],
  },
  {
    id: 'integridade',
    ...
    description: 'Como usar a verificação geral — Versão 1.0 Estável.',
    content: [
      'Acesse "Aparência e Manutenção" no menu lateral.',
      'Clique em "Iniciar Verificação" no painel "Verificar Integridade do Sistema".',
      'O sistema verifica: usuários, permissões, solicitações pendentes, relatórios, compras, rubricas, arquivos, notificações, logs e duplicatas.',
      'Os resultados são organizados em: Itens OK (verde), Alertas (amarelo) e Erros (vermelho).',
      'Para cada problema encontrado, são exibidas sugestões de correção.',
      'Use o botão "Exportar Relatório de Verificação" para salvar os resultados em JSON.',
      'Execute a verificação periodicamente (recomendado: uma vez por semana) para manter o sistema saudável.',
    ],
  },
  {
    id: 'versao',
    icon: ShieldCheck,
    title: 'Versão 1.0 — Estável',
    description: 'Changelog e informações sobre esta versão do sistema.',
    content: [
      'Esta é a versão 1.0 Estável da plataforma Museus Centro, fechada em maio de 2026.',
      'Inclui: Relatórios Mensais, Compras e Pagamentos, Equipe, Aprovações, Rubricas por Museu, Galeria de Fotos, Agenda, Programação, Ferramentas (Listas e Termos), Biblioteca de Conhecimento, Assistente de IA, Leitor de Notícias, Backup Google Drive e Verificação de Integridade.',
      'Novidades desta versão: envio automático de e-mail para financeiro ao aprovar compras, verificação de integridade do sistema, ferramenta de remoção de duplicados com backup automático e sistema de temas visuais.',
      'Melhorias futuras previstas para a versão 1.1: exportação avançada de relatórios, dashboard financeiro expandido e integração com planilha de programação em tempo real.',
      'Para suporte, utilize o Assistente de IA ou consulte a Biblioteca de Conhecimento.',
    ],
  },
];
