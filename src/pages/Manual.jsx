...
const SECOES = [
  {
    ...
    content: [
      ...
      'Os módulos do sistema se complementam: Compras, Equipe, Aprovações, Rubricas, Documentos, Agenda, Biblioteca de Conhecimento, Assistente de IA e Configuração.',
  ...
  },
  {
    ...
    content: [
      ...
      'Para pessoas jurídicas (PJ), informe o CNPJ. Para pessoas físicas (PF), informe o CPF. Não é necessário preencher os dois.',
  ...
  },
  {
    ...
    content: [
      ...
      'Ao clicar em Salvar ou Enviar, o sistema exibe confirmação visual do sucesso da ação.',
    ],
  },
  {
    id: 'equipe',
  ...
  },
  {
    ...
    content: [
      ...
      'Após enviar, a coordenação revisa e aprova ou devolve. Sem aprovação, não há pagamento.',
      'Ao enviar, o sistema exibe mensagem de sucesso e envia e-mails automáticos.',
    ],
  },
  {
    id: 'agenda',
    ...
    content: [
      ...
      'Em Dados Completos (Espelho da Planilha), veja sinopse, links de imagens, minibios e material de divulgação aprovado.',
  ...
  },
  {
    ...
    content: [
      'Use esta área para revisar solicitações de compra e envios da equipe.',
      ...
      'Após Aprovar ou Devolver, o sistema exibe mensagem de sucesso e notifica o solicitante por e-mail.',
      'O botão “Pagamento realizado” aparece quando o status é Aprovado, e ao clicar gera aviso de sucesso e e-mail ao profissional.',
    ],
  },
  {
    id: 'rubricas',
    ...
    content: [
      ...
      'A tela permite visualizar previsto, utilizado e saldo.',
