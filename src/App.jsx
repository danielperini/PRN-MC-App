  ...
  return (
    <div key={location.pathname}>
      <Routes>
        ...
        <Route
          path="/CorrecaoRubricasAdmin"
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/CorrecaoRubricasAdmin'))}
              pageName="CorrecaoRubricasAdmin"
            />
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/RelatorioExecucaoObjeto'))}
              pageName="RelatorioExecucaoObjeto"
            />
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/VarreduraDrive'))}
              pageName="VarreduraDrive"
            />
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/GaleriaNoturno'))}
              pageName="GaleriaNoturno"
            />
          }
        />
        <Route
          ...
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/RelatorioAtividadesFotos'))}
              pageName="RelatorioAtividadesFotos"
            />
          }
        />
        <Route
          path="/ImportarNoturno2026"
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/ImportarNoturno2026'))}
              pageName="ImportarNoturno2026"
            />
          }
        />
        <Route
          ...
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/BancoRelatorios'))}
              pageName="BancoRelatorios"
            />
          }
        />
        <Route
          path="/AuditoriaRubricas3Aditivo"
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/AuditoriaRubricas3Aditivo'))}
              pageName="AuditoriaRubricas3Aditivo"
            />
          }
        />
        <Route
          ...
          element={
            <SafePage
              Page={React.lazy(() => import('./pages/RelatorioAtividadesHtml'))}
              pageName="RelatorioAtividadesHtml"
            />
          }
        />
