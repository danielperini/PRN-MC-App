...
export default function ReviewModalNF(props) {
  ...
  const intakeComFallback = useMemo(() => {
    ...
    const resultado_ia = {
      ...
      competencia: escolherValor(ia.competencia, ia.nf_competencia, ia.competencia_sugerida, arquivo.competencia),
      competencia_sugerida: escolherValor(ia.competencia_sugerida, ia.competencia, ia.nf_competencia, arquivo.competencia_sugerida),
      ...
      nf_emitente_email: escolherValor(ia.nf_emitente_email, ia.email_emitente, ia.fornecedor_email, ''),
      nf_emitente_telefone: escolherValor(ia.nf_emitente_telefone, ia.telefone_emitente, ia.fornecedor_telefone, ''),
      ...
      nf_emitente_pix: escolherValor(ia.nf_emitente_pix, ia.fornecedor_pix, ''),
