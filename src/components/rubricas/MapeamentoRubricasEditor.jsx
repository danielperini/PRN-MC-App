  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-black">🔗 Mapeamento Automático</h3>
        <Button
          size="sm"
      ...
      {showForm && (
        <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 space-y-3">
          <div>
            <label className="text-sm font-semibold text-black block mb-2">Termo de Origem *</label>
            <Input
          ...
          <div>
            <label className="text-sm font-semibold text-black block mb-2">Rubrica Destino *</label>
            <Select
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th className="text-left p-3 font-semibold text-black">Termo de Origem</th>
              <th className="text-left p-3 font-semibold text-black">Rubrica Destino</th>
