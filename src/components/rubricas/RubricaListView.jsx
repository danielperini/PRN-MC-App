...
export default function RubricaListView({ onSelectRubrica }) {
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Gestão e controle do orçamento do Projeto Museus Centro</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-black mt-2">{totais.total_rubricas}</p>
          </div>
          <div className="border border-gray-200 rounded-lg p-4">
