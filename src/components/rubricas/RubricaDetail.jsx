...
Deno.serve(async (req) => {
  try {
    ...
    for (const rubrica of RUBRICAS_DEFAULT) {
      ...
      if (existente) {
        // preserva uso real já calculado
        ...
        const saldo = parseFloat((toNumber(rubrica.valor_rubrica) - valorUtilizadoInicial).toFixed(2));
        ...
        await base44.asServiceRole.entities.Rubrica.create({
          ...
          rubrica: rubrica.rubrica,
          numero_parcelas_unidades: rubrica.numero_parcelas_unidades,
          valor_rubrica: toNumber(rubrica.valor_rubrica),
