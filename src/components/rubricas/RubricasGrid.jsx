...
export default function RubricasGrid({
  ...
  const resumo = useMemo(() => {
    ...
    return { totalRubricas, totalPrevisto, totalUtilizado, saldoTotal, percentualGeral };
  }, [rubricasAtivas]);
                    ...
                    <CardContent className="p-5 space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                          <p className="text-[10px] text-gray-500 uppercase font-semibold tracking-wide">Previsto</p>
                          <p className="text-sm font-bold text-black mt-1">R$ {moeda(valorRubrica)}</p>
                        </div>
                        <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
                          <p className="text-[10px] text-blue-600 uppercase font-semibold tracking-wide">Utilizado</p>
                          <p className="text-sm font-bold text-blue-700 mt-1">R$ {moeda(valorUtilizado)}</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                        ...
                        {onSelectRubrica && (
                          <Button variant="outline" size="sm" onClick={() => onSelectRubrica(rubrica)}>
                            Detalhe
                          </Button>
                        )}
                      </div>
