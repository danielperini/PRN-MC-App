...
const CARGOS_FUNCOES = [
  ...
  'Educador(a) — Noturno',
  'Arte-educador(a)',
  'Arte-educador(a) — Diurno',
  'Arte-educador(a) — Noturno',
  'Mediador(a)',
  'Mediador(a) — Diurno',
  'Mediador(a) — Noturno',
  'Oficineiro(a)',
  'Oficineiro(a) — Diurno',
  'Oficineiro(a) — Noturno',
  // ── Produção / Técnico ───────────────────────────────────
  'Produtor(a)',
  'Assistente de Produção',
  'Técnico(a) de Som',
  'Técnico(a) de Som — Noturno',
  'Técnico(a) de Luz',
  'Técnico(a) de Luz — Noturno',
  'Técnico(a) de Palco',
  'Técnico(a) de Palco — Noturno',
  'Operador(a) de Som e Luz',
  'Operador(a) de Som e Luz — Noturno',
  // ── Comunicação / Mídia ──────────────────────────────────
  'Comunicador(a)',
  'Designer',
  'Fotógrafo(a)',
