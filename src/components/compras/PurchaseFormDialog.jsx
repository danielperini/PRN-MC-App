...
import { ChevronDown, ChevronUp, ExternalLink, Sparkles, Activity, DollarSign, CheckCircle, XCircle, Loader2, Trash2, AlertTriangle, Pencil } from 'lucide-react';
...
export default function PurchaseCard({ purchase, budgetLines, statusConfig, isCoordenador, isAdmin, onRefresh, currentUser, onEdit }) {
