    ...
    <section className="relative w-full rounded-[1.35rem] border border-border bg-card px-5 py-5 shadow-[0_18px_45px_rgba(15,23,42,0.06)] sm:px-7 lg:px-10">
      ...
      {items.length > 4 &&
       <button
         ...
         onClick={goPrevious}
         className="absolute left-0 top-1/2 z-10 hidden h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-card text-foreground shadow-lg transition-all hover:-translate-x-[55%] hover:bg-secondary lg:flex">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        ...
        {visible.map((item, i) =>
         <article
           ...
           className="group min-w-0 rounded-2xl border border-border bg-card p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-muted hover:shadow-md">
          
            <div className="flex h-full min-h-[150px] flex-col">

              <div className="mb-3 flex items-center justify-between gap-2">

                <span className="truncate rounded-full border border-border bg-secondary px-2.5 py-1 text-[9px] font-bold uppercase tracking-wide text-secondary-foreground shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
                  📡 {item.fonte}
                </span>

                {item.tags?.[0] &&
              <span className="hidden truncate rounded-full border border-border bg-secondary px-2 py-1 text-[9px] font-semibold text-secondary-foreground sm:inline">
                    {item.tags[0]}
                  </span>
              }
              ...
              {item.resumo &&
              <p className="mt-3 line-clamp-3 flex-1 text-xs leading-relaxed text-foreground">
                  {item.resumo}
                </p>
            }
              ...
              <div className="mt-5 flex items-center justify-between gap-3">
                ...
                className="inline-flex items-center gap-1 rounded-full border border-border bg-secondary px-2.5 py-1 text-xs font-semibold text-secondary-foreground transition-colors hover:bg-primary hover:text-primary-foreground">
      ...
      <button
        ...
        onClick={goNext}
        className="absolute right-0 top-1/2 z-10 hidden h-11 w-11 -translate-y-1/2 translate-x-1/2 items-center justify-center rounded-full border border-border bg-card text-foreground shadow-lg transition-all hover:translate-x-[55%] hover:bg-secondary lg:flex">
