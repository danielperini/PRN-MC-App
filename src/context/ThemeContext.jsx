...
export const THEMES = {
  ...
  museubh: {
    ...
    vars: {
      ...
      '--cor-alerta': '#FF5C5C',
      '--cor-fundo': '#F6EFE3',
      '--cor-fundo-secundario': '#EFE1C9',
      '--cor-texto': '#111827',
      '--cor-texto-secundario': '#374151',
      '--cor-card': '#FFFFFF',
      '--cor-card-secundario': '#F8F1E7',
      '--cor-destaque': '#7A1E2C',
      '--cor-borda': '#D9C6A5',
    ...
    preview: ['#7A1E2C', '#F6EFE3', '#EFE1C9', '#2E6F95'],
  },
  miro: {
    id: 'miro',
    nome: 'Museus BH',
    descricao: 'Paleta azul inspirada na Pampulha com sidebar azul escuro e fundos claros.',
    vars: {
      '--cor-primaria': '#0B1F3A',
      ...
      '--cor-alerta': '#D72638',
      '--cor-fundo': '#DCEEFF',
      '--cor-fundo-secundario': '#EEF6FF',
      '--cor-texto': '#FFFFFF',
      '--cor-texto-secundario': '#E2E8F0',
      '--cor-card': '#FFFFFF',
      '--cor-card-secundario': '#F4F9FF',
      '--cor-destaque': '#003B73',
      '--cor-borda': '#B8D4F0',
    ...
    preview: ['#0B1F3A', '#DCEEFF', '#003B73', '#3A8DDE'],
  },
  nuit: {
    id: 'nuit',
